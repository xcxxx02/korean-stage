...
describe('validateCourse', () => {
  ...
  it('provides the Lec 1 dataset with the confirmed four-member vocabulary allocation', () => {
    ...
    expect(course.dialogues[0].video.durationSeconds).toBeUndefined()
    expect(course.dialogues[1].video.durationSeconds).toBe(30)
    ...
    expect(blockingIssues).toContainEqual(expect.objectContaining({ code: 'dialogue-video-duration', dialogueId: 'dialogue-2' }))
  })
})
