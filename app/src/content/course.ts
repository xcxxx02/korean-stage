...
export const course: Course = {
  ...
  vocabulary: [
    ...
    vocabulary('student', 'unit-3', '학생', 'Student', 'haksaeng', 'hak-ssaeng', '저는 학생이에요.', 'I am a student.', null),
    vocabulary('teacher', 'unit-3', '선생님', 'Teacher', 'seonsaengnim', undefined, '저는 선생님이에요.', 'I am a teacher.', null),
    vocabulary('office-worker', 'unit-3', '회사원', 'Office worker', 'hoesawon', undefined, '저는 회사원이에요.', 'I am an office worker.', null),
    vocabulary('reporter', 'unit-3', '기자', 'Reporter', 'gija', undefined, '저는 기자예요.', 'I am a reporter.', null),
    vocabulary('doctor', 'unit-3', '의사', 'Doctor', 'uisa', undefined, '저는 의사예요.', 'I am a doctor.', null),
    vocabulary('singer', 'unit-3', '가수', 'Singer', 'gasu', undefined, '저는 가수예요.', 'I am a singer.', null),
    vocabulary('soldier', 'unit-3', '군인', 'Soldier', 'gunin', undefined, '저는 군인이에요.', 'I am a soldier.', null),
    vocabulary('chef', 'unit-3', '요리사', 'Chef', 'yorisa', undefined, '저는 요리사예요.', 'I am a chef.', null),
  ],
  grammar: [
    {
      id: 'ieyo-yeyo',
