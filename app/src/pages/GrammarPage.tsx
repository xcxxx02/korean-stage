        ...
        {course.grammar.map((grammarPoint) => {
          ...
          return (
            <li className="list-none" key={grammarPoint.id}>
              <Link className="block h-full rounded-xl border border-stage-border bg-stage-white p-6 transition hover:-translate-y-1 hover:border-stage-cobalt focus-visible:outline-3 focus-visible:outline-offset-3 focus-visible:outline-stage-focus" to={`/learn/${grammarPoint.unitId}`}>
