  ...
  dialogues: [
    ...
    },
    {
      ...
      lines: [
        ...
        dialogueLine('dialogue-2-line-2', 'member-3', '안녕하세요! 저는 조나단 이에요. 만나서 반가워요.', 'Hello! I’m Jonathan. Nice to meet you.'),
        dialogueLine('dialogue-2-line-3', 'member-4', '조나단씨 어느 나라사람이에요?', 'Which country are you from?'),
        dialogueLine('dialogue-2-line-4', 'member-3', '저는 말레이시아사람이에요.', 'I’m Malaysian.'),
        dialogueLine('dialogue-2-line-5', 'member-4', '조나단씨 학생이에요?', 'Are you a student?'),
        dialogueLine('dialogue-2-line-6', 'member-3', '네, 저는 대학생이에요.', 'Yes, I’m a university student.'),
        dialogueLine('dialogue-2-line-7', 'member-4', '조나단씨 전공이 뭐예요?', 'What is your major?'),
